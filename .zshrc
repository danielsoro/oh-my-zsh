# Path to your oh-my-zsh installation.
  export ZSH=/home/dcunha/.oh-my-zsh
...
plugins=(git weather web-search ssh-agent)
...
alias leao="cd ~/Documents/LEAO2016 && sh exec.sh"
alias mvninstall="mvn clean install -Darq.extension.webdriver.browser=chrome -Dwebdriver.chrome.driver=/usr/local/bin/chromedriver -T 10C"
